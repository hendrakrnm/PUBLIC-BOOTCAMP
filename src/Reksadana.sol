...
contract Reksadana is ERC20 {
    ...
    function totalAsset() public view returns (uint256) {
        (, int256 usdcPrice,,,) = IAggregatorV3(wbtcFeed).latestRoundData();
        ...
        uint256 totalWethAsset = (IERC20(weth).balanceOf(address(this)) * wethpriceInUsd) / 1e8;
    ...
    function deposit(uint256 amount) public {
        ...
        uint256 _totalAsset = totalAsset();
        ...
        if (totalShares == 0) {
            ...
            shares = amount * totalShares / _totalAsset;
        }
        ...
        //swqap
        uint256 amountIn = amount / 2; //ini ketinggalan
